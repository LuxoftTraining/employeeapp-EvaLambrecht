...
function amountInDep(dep) {
    return _employees_json__WEBPACK_IMPORTED_MODULE_0__["default"].employees.map(e=>e.department).filter(d=>d === dep).length;
}

//Total salary per department:
function sumSalaryInDep(dep) {
    return _employees_json__WEBPACK_IMPORTED_MODULE_0__["default"].employees.filter(e=>e.department === dep).map(e=>e.salary).reduce((a,b)=>a+b);
}
...
function maxSalaryInDep(dep) {
    return _employees_json__WEBPACK_IMPORTED_MODULE_0__["default"].employees.filter(e=>e.department === dep).map(e=>e.salary).reduce((a,b)=>a>b?a:b);
}
...
function depWithMaxSalary() {
    let uniqueDepartments = [...new Set(_employees_json__WEBPACK_IMPORTED_MODULE_0__["default"].employees.map(e=>e.department))]; //get list with all unique departements ["IT", "ABC"]
    let salaries = [];
...
function depEmployees(dep) {
    return _employees_json__WEBPACK_IMPORTED_MODULE_0__["default"].employees.filter(e=>e.department === dep).map(e=>e.name+" "+e.surname);
}
...
function employeesWithSalaryMoreThan(salary) {
    return _employees_json__WEBPACK_IMPORTED_MODULE_0__["default"].employees.filter(e=>e.salary > salary).map(e=>e.name+" "+e.surname);
}
